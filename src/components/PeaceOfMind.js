    ...
    return(
        <section className='flex peace-of-mind-container'>
            <div className='peace-of-mind-left-section'>
                <img className='peace-of-mind-image' src= {peaceofmind} alt="Darya River's director standing in front of a room and explaining the strategy to two of the employees who are sitting down on sofa" />
            </div>
